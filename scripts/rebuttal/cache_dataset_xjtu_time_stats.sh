...
# ==========================================================================
# Pre-caching run for scripts/rebuttal/nb14_unibo_xjtu_time_stats_ablation.sh
# (xjtu_sy leg): builds the preprocessing cache for the temporal-only
# transforms=bearings/xjtu_sy/statistics pipeline once, single-threaded,
# before the full model sweep launches many parallel jobs against it.
# ==========================================================================
