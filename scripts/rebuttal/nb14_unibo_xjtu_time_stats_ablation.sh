...
# ==========================================================================
# Feature ablation: for nb14, unibo and xjtu_sy, "combined" concatenates
# TimeStatsTransform (temporal) + SpectralStatsTransform (spectral) features.
# This script reruns the same "combined" experiments but overrides the
# `transforms` config group with a temporal-only pipeline (the spectral
# block dropped, time-domain stats fed straight into "features"), to show
# how much of the "combined" performance comes from the spectral features.
# ==========================================================================

max_epochs=200
check_val_every_n_epoch=1
device=0
wandb_log_folder="rebuttal_time_stats_ablation"
...
# subexp still selects the "combined" experiment (model/task_definition/evaluator
# scaffolding); transforms_override swaps in the temporal-only pipeline on top.
datasets=(
  "nb14|combined|prognostics|battery/nb14/statistics"
  "unibo|combined|prognostics|battery/unibo/statistics"
  "xjtu_sy|in_domain/combined|prognostics|bearings/xjtu_sy/statistics"
)
