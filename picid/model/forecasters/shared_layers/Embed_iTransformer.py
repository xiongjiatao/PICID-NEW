...
class ContextEmbedding(nn.Module):
    def __init__(
        self, c_in, c_context, d_model, embed_type="timeF", freq="h", dropout=0.1
    ):
        ...
        print(
            "WARNING: Using Context Embedding that is designed for 16 dimensions, change for other datasets"
        )
    ...
    def forward(self, x, x_mark):
        ...
        x = (
            ...
            + self.context_embedding(context_features)
